-- Update function to optimize table assignments for both increases and decreases in guest count
...
BEGIN
  ...
  -- Always find optimal table assignment for the new guest count
  ...
  -- Replace assignments atomically with optimized table selection
