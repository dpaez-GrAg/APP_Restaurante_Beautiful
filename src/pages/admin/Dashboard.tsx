{{ ... }}
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-green-600">{data.confirmedReservations}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-blue-600">{data.completedReservations}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-red-600">{data.cancelledReservations}</div>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Total Comensales</CardTitle>
                <Users className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">{data.totalGuests}</div>
                <p className="text-xs text-muted-foreground">Solo confirmadas</p>
              </CardContent>
            </Card>
          </div>
{{ ... }}
