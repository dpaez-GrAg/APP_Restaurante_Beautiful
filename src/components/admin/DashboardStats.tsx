  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
      ...
      >
        ...
        <CardContent>
          <div className="text-2xl font-bold text-restaurant-brown">{stats.todayReservations}</div>
          <p className="text-xs text-muted-foreground">Mesas hoy</p>
        </CardContent>
      </Card>

      <Card className="shadow-elegant hover:shadow-glow transition-all duration-300">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium text-muted-foreground">Comensales</CardTitle>
          <Users className="h-4 w-4 text-restaurant-gold" />
        </CardHeader>
        <CardContent>
          <div className="text-2xl font-bold text-restaurant-brown">{stats.totalGuests}</div>
      ...
      >
        ...
        <CardContent>
          <div className="text-2xl font-bold text-restaurant-brown">{stats.occupancyRate}%</div>
          <p className="text-xs text-muted-foreground">De {stats.totalTables} mesas</p>
        </CardContent>
      </Card>
    </div>
  );
